...
Add the Swift package and include the `RunAnywhereLlamaCPP` product (pin `0.20.29`):

```swift
dependencies: [
    .package(url: "https://github.com/RunanywhereAI/runanywhere-swift.git", exact: "0.20.29"),
],
targets: [
    .target(
        name: "YourApp",
